...
using LW.Agents.Common;

namespace LW.Agents.DBUtility
{
    /// <summary>
    /// SqlHelper 的摘要说明。
    /// </summary>
    ...
    {
        public static string Dbxjpgameweb = WebConfigurationManager.ConnectionStrings["xjpgameweb"].ConnectionString;
        
        public static string Dbxjpaccountsdb = WebConfigurationManager.ConnectionStrings["xjpaccountsdb"].ConnectionString;
                                             ...
                                             params SqlParameter[] commandParameters)
        {
            ...
            {
                connection.Close();
                LogUtils.WriteLogFile("执行" + commandText + "时" + ex.Message.ToString(), "异常日志");
            }
            return null;
        }
        ...
        public static DataTable DataTablePage(string connectionString, string cmdText, int page, int pageSize)
        {
            ...
            {
                LogUtils.WriteLogFile("执行" + cmdText + "时" + ex.Message.ToString(), "异常日志");
            }
            return null;
        }

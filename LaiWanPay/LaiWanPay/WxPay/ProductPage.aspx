<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductPage.aspx.cs" Inherits="LaiWanPay.WxPay.ProductPage" %>
<!DOCTYPE html>
		...
		<main>
			<div class="box form">
				<div class="hint">
					...
					<p style="color: red;">1、请确认是在微信客户端内打开代理后台</p>
					<p style="color: red;">2、成功购买后房卡直接充值到代理帐号中</p>
					<p style="color: red;">3、房卡将充入您当前代理帐号，请确认无误</p>
				</div>
			</div>
			...
			<div class="box rechage-area">
				...
				<p class="rechage-money"><label>应付金额:</label> <asp:Label ID="AmountPayable" runat="server" style="color:#00CD00;" Text="1000"></asp:Label> 元</p><input type="hidden" id="hdpaymoney" value="1000" runat="server"/>
			</div>
			<div class="btn-ctrl">                
                <asp:Button ID="Button1" runat="server" Text="立即充值" OnClientClick="return validate()" CssClass="btn btn-success radius l" style="line-height: 1.6em; margin-top: 3px; width: 165px;" OnClick="Button1_Click" />
			</div>
		</main>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#ProductList').delegate('li', 'click', function () {
                    ...
                    $('#hdpaymoney').val($(this).attr('price'))
                });
            });
            function validate() {
                var payvalue = $("#hdpaymoney").val();
                if (payvalue == "0") {
                    alert("请选择充值金额。");
                    return false;
                }

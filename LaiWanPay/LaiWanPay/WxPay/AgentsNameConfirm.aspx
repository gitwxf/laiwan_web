<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentsNameConfirm.aspx.cs" Inherits="LaiWanPay.WxPay.AgentsNameConfirm" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <main>
            <div class="box form">
                <div class="hint">
                    <p style="font-size:16px;color:red; font-weight:bold;font-family:'Microsoft YaHei'">您当前绑定的代理帐号：<asp:Literal ID="ltAgentsName" runat="server" ></asp:Literal>，确认为该帐号充值？</p>
                </div>
            </div>
        ...
        <script type="text/javascript">
            function confirmpay() {
                window.location.href = "ProductPage.aspx?AgentsID=" + $("#hdAgentsId").val() + "&KindID=" + $("#hdKindId").val() + "&t=" + new Date().getTime();
            }
            function changeaccount() {
                window.location.href = "BindAccounts.aspx?OpenID=" + $("#hdOpenId").val();
            }
        </script>        
    </form>
</body>

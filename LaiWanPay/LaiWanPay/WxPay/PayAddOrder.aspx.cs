...
namespace LaiWanPay.WxPay
{
    public partial class PayAddOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //充值金额(微信那边需乘以100，分为单位)
            int intPayMoney;
            int.TryParse(strPayMoney, out intPayMoney);

            if (string.IsNullOrEmpty(strKindId) || string.IsNullOrEmpty(strAgentsId) || !listPayValue.Contains(intPayMoney))
            {
            ...
            //PC扫码支付
            Response.Redirect("NativePayPage.aspx?PayMoney=" + (intPayMoney * 100) + "&OrderId=" + orderId, true);    
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected bool GetMchineType()
        {
            string str_u = this.Request.ServerVariables["HTTP_USER_AGENT"];

    ...
    public class ResultNotify:Notify
    {
        ...
        public override void ProcessNotify()
        {
            ...
            if (!notifyData.IsSet("transaction_id"))
            {
                ...
                LogUtils.WriteLogFile("transaction_id不存在，" + res.ToXml(), "QueryOrder");
            ...
            if (!QueryOrder(transaction_id))
            {
                ...
                LogUtils.WriteLogFile("订单查询失败，" + res.ToXml(), "QueryOrder");
                page.Response.Write(res.ToXml());
                page.Response.End();
            }
            else  //查询订单成功
            {
                ...
                LogUtils.WriteLogFile("订单成功，transaction_id：" + transaction_id + "，out_trade_no：" + out_trade_no + "，total_fee：" + total_fee, "QueryOrder");
                //处理订单
                ...
                LogUtils.WriteLogFile("订单处理结果：" + result, "QueryOrder");
                page.Response.Write(res.ToXml());
                page.Response.End();
            }
        }

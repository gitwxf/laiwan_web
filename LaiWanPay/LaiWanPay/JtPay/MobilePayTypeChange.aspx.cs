...
{
    public partial class MobilePayTypeChange : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["Terminal"] != null && Request.QueryString["Terminal"].ToString() != "")
                {
                    hdTerminal.Value = Request.QueryString["Terminal"].ToString();
                }
            }
        }
    }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PcPayTypeChange.aspx.cs" Inherits="LaiWanPay.JtPay.PcPayTypeChange" %>
    ...
    <form id="form1" runat="server">
        ...
        <main>
            ...
            <div class="box rechage-area">
                <p class="rechage-money">
                    <label>订单金额:</label>
                    <asp:Literal ID="AmountPayable" runat="server" Text="0"></asp:Literal>
                    元</p>
            </div>
            <div class="btn-ctrl">
                <input type="hidden" id="hdpaytype" value="wx"/><input type="hidden" id="hdOrderId" runat="server" /><input type="hidden" id="hdPayMoney" runat="server" /><input type="hidden" id="hdAgentsId" runat="server" />
                <a class="btn btn-success radius l" id="reBtn" href="javascript:;" onclick="confirm();">确定</a>
            </div>
        </main>
        ...
        <script type="text/javascript">
            ...
            function confirm() {
                ...
                switch (paytype) {
                    case "wx": 
                        window.location.href = "JtpayPost.aspx?amount=" + amount + "&payAccounts=" + payAccounts + "&orderId=" + orderId + "&p9_paymethod=3&p25_terminal=1&p26_iswappay=1";
                        break;
                    case "zfb":
                        window.location.href = "JtpayPost.aspx?amount=" + amount + "&payAccounts=" + payAccounts + "&orderId=" + orderId + "&p9_paymethod=4&p25_terminal=1&p26_iswappay=1";
                        break;
                }
            }
        </script>

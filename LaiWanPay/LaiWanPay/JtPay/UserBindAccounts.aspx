<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBindAccounts.aspx.cs" Inherits="LaiWanPay.JtPay.UserBindAccounts" %>
...
<body>
    ...
    <h4>说明：</h4>
	<p>1.您可以在这里填写游戏ID，将游戏ID绑定在本微信帐号上《游戏ID在游戏左上角》。</p>

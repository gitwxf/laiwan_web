<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobilePayDefault.aspx.cs" Inherits="LaiWanPay.JtPay.MobilePayDefault" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#reBtn").click(function () {
                    ...
                    window.location.href = "PayAddOrder.aspx?KindID=" + kindId + "&AgentsID=" + agentsId + "&PayMoney=" + payvalue + "&Terminal=" + terminal + "&t=" + new Date().getTime();
                });
            });
        </script>
    </form>

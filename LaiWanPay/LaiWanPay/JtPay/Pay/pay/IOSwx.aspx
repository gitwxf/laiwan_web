<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IOSwx.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.IOSwx" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IOS微信wap</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('IOSwx')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="azwxtc.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.azwxtc" %>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('azwxtc')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

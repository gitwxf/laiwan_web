<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JtpayWY.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.JtpayWY" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>竣付通网银收银台</title>
...
<body>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('bank')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>
    ...
    <script src="../js_v2/game_bank_min_v20150420.js"></script>
    </form>
</body>
</html>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JtpayZFB.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.JtpayZFB" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>竣付通支付宝收银台</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('zhifubao')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

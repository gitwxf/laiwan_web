<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IOSgzh.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.IOSgzh" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IOS微信公众号</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('IOSgzh')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

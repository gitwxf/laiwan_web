<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JtpayKL.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.JtpayKL" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>竣付通卡类收银台</title>
    ...
    <script src="../js_v2/yb_min_v20150316.js" type="text/javascript"></script>
                ...
                <table class="paymentTable">
                    ...
                    <tr>
 	                ...
 	                <tr>
		                ...
		                <th align="right">充值卡类：</th>
		                <td>
			                <ul class="simRadio recharge clearfix" id="channelChooseElt">
				                <li data="1"class="unChoose select" onclick="chooseChannel(this)"><span>盛大卡</span></li>
				                <li data="2" class="unChoose" onclick="chooseChannel(this)"><span>易宝卡</span></li>
				                <li data="3" class="unChoose" onclick="chooseChannel(this)"><span>征途卡</span></li>
				                <li data="4" class="unChoose" onclick="chooseChannel(this)"><span>完美通</span></li>
                                <li data="5" class="unChoose" onclick="chooseChannel(this)"><span>网易通</span></li>
				                <li data="6" class="unChoose" onclick="chooseChannel(this)"><span>搜狐通</span></li>
				                <li data="7" class="unChoose" onclick="chooseChannel(this)"><span>久游通</span></li>
				                <li data="8" class="unChoose" onclick="chooseChannel(this)"><span>神州行卡</span></li>
                                <li data="9" class="unChoose" onclick="chooseChannel(this)"><span>联通卡</span></li>
				                <li data="10" class="unChoose" onclick="chooseChannel(this)"><span>电信卡</span></li>
				                <li data="11" class="unChoose" onclick="chooseChannel(this)"><span>Q币卡</span></li>
				                <li data="12" class="unChoose" onclick="chooseChannel(this)"><span>纵游卡</span></li>
                                <li data="13" class="unChoose" onclick="chooseChannel(this)"><span>天下卡</span></li>
				                <li data="14" class="unChoose" onclick="chooseChannel(this)"><span>天宏卡</span></li>
				                <li data="15" class="unChoose" onclick="chooseChannel(this)"><span>骏网卡</span></li>
	                ...
	                <tr>
                        ...
                        <td>
                           <input type="text" class="input" id="prepaidCardSerialNumber" name="passport" runat="server">
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                        ...
                        <td>
                           <input type="text" class="input" id="prepaidCardPassword" name="passport" runat="server">
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('kalei')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

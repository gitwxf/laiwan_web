<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AZZFB.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.AZZFB" %>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('AZZFB')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

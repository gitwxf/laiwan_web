<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AZGZH.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.AZGZH" %>
<!DOCTYPE html>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('AZGZH')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

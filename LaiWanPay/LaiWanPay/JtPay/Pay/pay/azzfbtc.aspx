<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="azzfbtc.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.azzfbtc" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>安卓支付宝wap弹出</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('azzfbtc')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

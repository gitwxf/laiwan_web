<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JtpayKJ.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.JtpayKJ" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>竣付通快捷收银台</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('kuaijie')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>

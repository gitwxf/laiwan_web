<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IOSzfb.aspx.cs" Inherits="LaiWanPay.JtPay.Pay.pay.IOSzfb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IOS支付宝wap</title>
            ...
            <div class="payment">
                <table class="paymentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="imgBtn largeBtn" onclick="submitToDeposit('IOSzfb')">
                                <%--立即支付--%></a>
                        </td>
                    </tr>
                </table>
